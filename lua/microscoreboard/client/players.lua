...
local function CreateMenuPanel(ply)
	...
	CopySubMenu:AddOption("Profile URL", function() SetClipboardText("http://steamcommunity.com/profiles/" .. ply:SteamID64()) end):SetMaterial(svg.Cache["MS_DMenu_CopyProfileURL"].mat)
